...
func _build_ui() -> void:
        ...
        score_display.mouse_filter = Control.MOUSE_FILTER_IGNORE  ## НЕ блокируем клики!
        ...
        planet_info_panel.mouse_filter = Control.MOUSE_FILTER_IGNORE
        ...
        defeat_screen.mouse_filter = Control.MOUSE_FILTER_IGNORE
